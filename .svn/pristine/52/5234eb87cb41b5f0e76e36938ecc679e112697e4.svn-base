...
@RestController
public class WorkOrderBatchProcessController {

    private static final Logger logger = LoggerFactory.getLogger(WorkOrderBatchProcessController.class);
    ...
    public WorkOrderBatchProcessController(WorkOrderBatchMapper workOrderBatchMapper){
    ...
    ModelAndView index(Map<String, Object> model) {
        ...
        return new ModelAndView("workOrderBatchProcess");
    }
