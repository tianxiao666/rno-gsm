...
public class WorkOrderStatisticsController {
    ...
    ModelAndView index(HttpServletRequest request) {
        logger.debug("访问工单统计首页");
        return new ModelAndView("workOrderStatistics");
    }


    @PostMapping("/getWorkOrderStatistics")
    List<Map<String, Object>> getWorkOrderStatistics(HttpServletRequest request) {
